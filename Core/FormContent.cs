...
namespace Greatbone.Core
{
    ...
    public class FormContent : DynamicContent, IDataOutput<FormContent>
    {
        ...
        public FormContent Put(string name, IData v, ushort proj = 0, string Label = null)
        {
            return this;
        }

        public FormContent Put<D>(string name, D[] v, ushort proj = 0, string Label = null) where D : IData
        {
            return this;
        }
    }
