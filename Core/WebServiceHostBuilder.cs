...
{
	public class WebServiceHostBuilder : IWebHostBuilder
	{
		...
		public WebServiceHostBuilder()
		{
			...
			if (string.IsNullOrEmpty(GetSetting(WebHostDefaults.EnvironmentKey)))
			{
				...
				UseSetting(WebHostDefaults.EnvironmentKey,
					Environment.GetEnvironmentVariable("Hosting:Environment") ?? Environment.GetEnvironmentVariable("ASPNET_ENV"));
			}
		...
		public IWebHost Build()
		{
			...
			var host = new WebServiceHost(hostingServices, hostingContainer, _options, _config);
