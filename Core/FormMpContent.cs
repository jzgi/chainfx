...
namespace Greatbone.Core
{
    ...
    public class FormMpContent : DynamicContent, IDataOutput<FormMpContent>
    {
        ...
        public FormMpContent Put(string name, IData v, ushort proj = 0x00ff, string Label = null)
        {
            Part(name);
            if (v == null)
            {
        ...
        public FormMpContent Put<D>(string name, D[] v, ushort proj = 0x00ff, string Label = null) where D : IData
        {
            Part(name);
            if (v == null)
            {
