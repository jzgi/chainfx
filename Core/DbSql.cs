...
namespace Greatbone.Core
{
    ...
    public class DbSql : DynamicContent, IDataOutput<DbSql>
    {
        ...
        public DbSql setlst(IData obj, ushort proj = 0x00ff)
        {
            ctx = CTX_SETLIST;
            ordinal = 1;
        ...
        public DbSql columnlst(IData obj, ushort proj = 0x00ff)
        {
            ctx = CTX_COLUMNLIST;
            ordinal = 1;
            obj.WriteData(this, proj);
        ...
        public DbSql parameterlst(IData obj, ushort proj = 0x00ff)
        {
            ctx = CTX_PARAMLIST;
            ordinal = 1;
            obj.WriteData(this, proj);
        ...
        public DbSql _(IData obj, ushort proj = 0x00ff, string extra = null)
        {
            Add(" (");
            columnlst(obj, proj);
            if (extra != null)
        ...
        public DbSql _VALUES_(IData obj, ushort proj = 0x00ff, string extra = null)
        {
            Add(" VALUES (");
        ...
        public DbSql _SET_(IData obj, ushort proj = 0x00ff, string extra = null)
        {
            Add(" SET ");
            setlst(obj, proj);
            if (extra != null)
        ...
        public DbSql Put(string name, IData v, ushort proj = 0x00ff, string Label = null)
        {
            if (name != null)
            {
                Build(name);
        ...
        public DbSql Put<D>(string name, D[] v, ushort proj = 0x00ff, string Label = null) where D : IData
        {
            Build(name);
            return this;
        }
