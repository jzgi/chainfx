...
namespace Greatbone.Core
{
    ...
    public class HtmlContent : DynamicContent, IDataOutput<HtmlContent>, IMenu, ISelectOptions
    {
        ...
        public void FORM<D>(WebAction[] acts, D[] arr, ushort flags = 0) where D : IData
        {
            Add("<form class=\"pure-form pure-g\">");
        ...
        public void FORM<D>(WebAction act, D dat, ushort flags = 0) where D : IData
        {
            Add("<form class=\"pure-form pure-g\">");
        ...
        public HtmlContent Put(string name, IData v, ushort flags = 0)
        {
            return this;
        }
        ...
        public HtmlContent Put<D>(string name, D[] v, ushort flags = 0) where D : IData
        {
            return this;
        }

        public HtmlContent Put<D>(string name, List<D> v, ushort flags = 0) where D : IData
        {
            throw new NotImplementedException();
        }
