...
namespace Greatbone.Sample
{
    ...
    public static class WebContextUtility
    {
        ...
        public static void SendHtmlMajor(this WebExchange wc, int status, string title, Action<HtmlContent> main, bool? pub = null, int maxage = 60000)
        {
        ...
        public static void SendHtmlMinor(this WebExchange wc, int status, string header, Action<HtmlContent> main, bool? pub = null, int maxage = 60000)
        {
        }

        public static void SendHtmlDialog(this WebExchange wc, int status, Action<HtmlContent> main, bool? pub = null, int maxage = 60000)
        {
            HtmlContent cont = new HtmlContent(true, true, 8 * 1024)
            {
                Map = Map
