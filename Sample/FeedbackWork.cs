...
{
    ///
    public abstract class FeedbackWork : Work
    {
        protected FeedbackWork(WorkContext wc) : base(wc)
        {
        }
    }
    ...
    [Ui("反馈/申诉")]
    [User]
    public class MyFeekbackWork : FeedbackWork
    {
        public MyFeekbackWork(WorkContext wc) : base(wc)
        {
        }
    ...
    [Ui("反馈/申诉")]
    [User(spr: true)]
    public class SprFeekbackWork : FeedbackWork
    {
        public SprFeekbackWork(WorkContext wc) : base(wc)
        {
        }
    ...
    [Ui("反馈/申诉")]
    [User(adm: true)]
    public class AdmFeekbackWork : FeedbackWork
    {
        public AdmFeekbackWork(WorkContext wc) : base(wc)
        {
        }
