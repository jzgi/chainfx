...
namespace Ministry.Dietary
{
    ...
    public class WeChatContent : DynamicContent, ISink<WeChatContent>, IMenu, ISelectOptions
    {
        ...
        public WeChatContent Put<V>(string name, V v, byte z = 0) where V : IPersist
        {
            return this;
        }

        public WeChatContent Put(string name, JObj v)
        {
            return this;
        }

        public WeChatContent Put(string name, JArr v)
        {
            return this;
        }
