    ...
    public class AdmUserWork : UserWork<OprUserVarWork>
    {
        ...
        public void @default(ActionContext ac, int page)
        {
            ...
            using (var dc = ac.NewDbContext())
            {
                ...
                {
                    ac.GiveTablerPage(200, dc.ToArray<User>(), h => h.TH("姓名").TH("电话").TH("城市").TH("地址").TH("操作于").TH("操作岗").TH("管理员"), (h, o) => h.TD(o.name).TD(o.tel).TD(o.city).TD(o.addr).TD(o.oprat).TD(User.OPRS[o.opr]).TD(o.adm)); // ok
                }
                else
                {
