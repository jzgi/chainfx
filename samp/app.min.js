...
function dialog(trig, mode, pick, siz, title) {
    var sizc = siz = 0 ? '' : siz == 1 ? ' uk-modal-half uk-animation-slide-bottom' : ' uk-modal-full uk-animation-slide-right';
...
function crop(trig, ordinals, siz, title) {
    ...
    html += '<button class="uk-button uk-button-default uk-border-rounded" onclick="document.getElementById(\'imginp\').click()">选择</button>';
    html += '<button class="uk-button uk-button-default uk-border-rounded" onclick="upload(document.getElementById(\'imgbind\'), \'' + action + '\', (document.getElementById(\'imgord\') ? document.getElementById(\'imgord\').value : 0));">上传</button>';
