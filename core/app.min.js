...
function dialog(trig, mode, pick, siz, title) {
    ...
    var html = '<div class="uk-modal uk-animation-slide-right' + sizc + trigc + '" uk-modal="bg-close: false">';
    html += '<div class="uk-modal-dialog uk-margin-auto-vertical">';
    html += '<div class="uk-modal-header"><span class="uk-modal-title">' + title + '</span><button class="uk-modal-close-default" type="button" uk-close></button></div>';
    html += '<div class="uk-modal-body uk-padding-remove"><iframe src="' + src + '" style="width: 100%; height: 100%; border: 0"></iframe></div>';
    if (mode != OPEN) {
        html += '<div class="uk-modal-footer uk-text-center"><button id="okbtn" class="uk-button uk-button-default uk-border-rounded" type="button" onclick="ok(this,' + mode + ',\'' + formid + '\',\'' + tag + '\',\'' + action + '\',\'' + method + '\');" disabled>确定</button></div>'
    }
    html += '</div></div>';
