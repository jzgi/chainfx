...
function crop(trig, ordinals, siz, title) {
    ...
    html += '</div>'; // header
    html += '<div class="uk-modal-body uk-padding-remove crop"><input type="file" name="imginp" style="display: none;" onchange="bind(this.parentNode, window.URL.createObjectURL(this.files[0]), this.form.ordinal.value,' + wid + ',' + hei + ');"></div>';
    html += '</form>'; // uk-dialog
    html += '</div>'; // uk-modal
