...
function dialog(trig, mode, pick, siz, title) {
    ...
    var html = '<div class="' + stylec + trigc + '" uk-modal>';
...
function crop(trig, ordinals, siz, title) {
    ...
    var html = '<div class="uk-modal-full' + trigc + '" uk-modal>';
    html += '<section class="uk-modal-dialog">';
    html += '<header class="uk-modal-header">';
    html += '<nav class="uk-button-group">';
    if (ordinals > 0) {
        html += '<select id="imgord" onchange="bind(document.getElementById(\'imgbnd\'), \'' + action + '\', this.value, ' + wid + ', ' + hei + ')">';
        for (var i = 1; i <= ordinals; i++) {
            html += '<option value="' + i + '">' + i + '</option>';
        }
        html += '</select>';
    }
    html += '<a class="uk-button uk-button-default" onclick="document.getElementById(\'imginp\').click()">选择</a>';
    html += '<button class="uk-button uk-button-default" onclick="upload(document.getElementById(\'imgbnd\'), \'' + action + '\', (document.getElementById(\'imgord\') ? document.getElementById(\'imgord\').value : 0));">上传</button>';
    ...
    var e = appendTo(document.body, html);
    UIkit.modal(e).show();
    bind(document.getElementById('imgbnd'), action, (ordinals > 0 ? 1 : 0), wid, hei);
    e.addEventListener('hidden', function () {
        document.body.removeChild(e);
    }, false);
    return false;
