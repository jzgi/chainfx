...
function dialog(trig, mode, pick, siz, title) {
    var stylec =
        siz == 1 ? ' uk-modal-half uk-animation-slide-bottom' :
            siz == 2 || siz == 0 ? ' uk-modal-side uk-animation-slide-right' :
                siz == 3 ? ' uk-modal-small' :
                    siz == 4 ? ' uk-modal-large' :
                        ' uk-modal-full';
